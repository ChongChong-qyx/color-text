...
教程见 https://pypi.org/project/color-text/3.1.8/ 或 Python 安装文件夹\Lib\site-packages\color_text\doc 中的教程。
Tutorial see https://pypi.org/project/color-text/3.1.8/ or tutorials in Python installation folder\Lib\site-packages\color_text\doc.
"""
